...
const moonPhases = { 'New Moon': 'nueva', 'Waxing Crescent': 'creciente', 'First Quarter': 'cuarto creciente', 'Waxing Gibbous': 'menguante', 'Full Moon': 'llena', 'Waning Gibbous': 'menguante', 'Last Quarter': 'último cuarto', 'Waning Crescent': 'creciente menguante' }
...
const moonPhaseToSpanish = (phase) => moonPhases[phase] || phase
...
export { getWindText, getVisibilityText, getRadiationUVText, moonPhaseToSpanish, epochToDay, epochToHour, indexToDay, remap };